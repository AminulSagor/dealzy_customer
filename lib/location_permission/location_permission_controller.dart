...
class LocationPermissionController extends GetxController {
  ...
  Future<void> requestLocation() async {
    ...
    try {
      ...
      if (!serviceEnabled) {
        Get.snackbar('Location services are off', 'You can continue without it.');
        _goNext();
        return;
      }
      ...
      if (permission == LocationPermission.denied) {
        Get.snackbar('Permission denied', 'No problem—you can enable it later from Settings.');
        _goNext();
        return;
      }

      if (permission == LocationPermission.deniedForever) {
        Get.snackbar('Permission permanently denied', 'You can enable it later from Settings.');
        _goNext();
        return;
      }
